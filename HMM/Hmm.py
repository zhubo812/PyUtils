...
def cal_hmm_matrix(observation):
    # 得到所有标签
    word_pos_file = open('E:/BaiduNetdiskDownload/ChineseDic.txt',encoding='utf-8').readlines()
    tags_num = {}
    ...
    # 计算转移矩阵和发射矩阵
    word_file = open('E:/BaiduNetdiskDownload/199801.txt',encoding='utf-8').readlines()
    ...
    for row in range(emission_matrix.shape[0]):
        ...
        num = tags_num[tags_list[row]] + 1#当前词性的总频次+1
        print(num)
